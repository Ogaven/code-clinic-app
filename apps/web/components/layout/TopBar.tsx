...
import { Bell, Check, Download, LogOut, Menu, Monitor, Moon, Search, Settings, Sun, User, UserRound, X } from 'lucide-react'
...
const NAV: NavLink[] = [
  ...
  { label: 'CRM', children: [
    ...
    { label: 'Leads', href: '/leads', children: [
      { label: 'Pipeline', href: '/leads' },
      { label: 'Needs Attention', href: '/crm/needs-attention' },
      { label: 'Sources', href: '/crm/sources' },
      { label: 'Campaigns', href: '/campaigns' },
      { label: 'Referrals', href: '/crm/referrals' },
      { label: 'Revenue', href: '/crm/revenue' },
      { label: 'Reports', href: '/crm/reports' },
    ] },
    { label: 'Patient Engagement', href: '/crm/recall', children: [
      { label: 'Recall', href: '/crm/recall' },
      { label: 'Treatment Follow-up', href: '/crm/treatment-followup' },
      { label: 'Reactivation', href: '/crm/reactivation' },
      { label: 'Waitlist', href: '/waitlist' },
      { label: 'Reviews', href: '/crm/reviews' },
      { label: 'Collections', href: '/crm/collections' },
    ] },
...
export default function TopBar({ title, user, theme, onThemeChange, install }: TopBarProps) {
  ...
  return (
    <>
      ...
      {menuOpen && <MobileMenu pathname={pathname} user={user} theme={theme} onTheme={chooseTheme} onNavigate={href => { router.push(href); setMenuOpen(false) }} onSignOut={signOut} onClose={() => setMenuOpen(false)} install={install} />}
    </>
  )
}

  ...
  return (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-gray-500 dark:text-white/50">Patients with an incomplete treatment plan awaiting follow-up, sourced from the treatment pipeline.</p>
      </div>

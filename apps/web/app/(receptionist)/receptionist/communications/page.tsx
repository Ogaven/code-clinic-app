...
import {
  ...
  MessageSquare, Users, Plus, Star, Stethoscope, Bell, RefreshCw,
} from 'lucide-react'
...
export default function CommunicationsPage() {
  const [channel, setChannel]       = useState<'email' | 'internal' | 'doctors'>('doctors')
  ...
  return (
    <div className="h-full flex flex-col bg-gray-50 dark:bg-transparent" style={{ minHeight: 0 }}>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        {/* WhatsApp moved to AI Suite → Inbox */}
        {(channel as string) === 'whatsapp' && (
          <>
            {/* List panel */}

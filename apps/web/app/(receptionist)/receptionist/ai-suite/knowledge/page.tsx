...
import KnowledgeSourcesPanel from '@/components/knowledge-studio/KnowledgeSourcesPanel'
import KnowledgeTrainerChat from '@/components/knowledge-studio/KnowledgeTrainerChat'
...
export default function KnowledgeBasePage() {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex-1 overflow-hidden lg:flex lg:gap-4 lg:p-5">
        <div className={cn(

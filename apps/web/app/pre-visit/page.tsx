    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 text-center">
      ...
      {appt && (
        <div className="mt-6 bg-cyan-50 border border-cyan-200 rounded-2xl px-6 py-4 text-sm text-cyan-800 max-w-sm">
          ...
          <p>{new Date(appt.startAt).toLocaleString('en-UG', { weekday: 'short', day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Africa/Kampala' })}</p>
        </div>
      )}
    </div>
  )
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5 pb-12">
        ...
        {appt && (
          <div className="bg-white rounded-2xl border border-cyan-200 p-4 shadow-sm">
            ...
            <p className="text-sm text-gray-500">Dr. {appt.doctor?.user?.firstName} {appt.doctor?.user?.lastName} · {new Date(appt.startAt).toLocaleString('en-UG', { weekday: 'short', day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit', hour12: true, timeZone: 'Africa/Kampala' })}</p>
          </div>
        )}

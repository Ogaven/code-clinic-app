  ...
  return (
    <div className="space-y-4 p-4 md:p-6 pb-24 md:pb-6 animate-fade-in">
      <div className="flex items-center gap-3">
        ...
        <button onClick={fetchNotifs} className="p-2.5 rounded-xl border border-gray-200 dark:border-white/10 hover:bg-gray-100 dark:hover:bg-white/10 text-gray-500 dark:text-gray-400">
          <RefreshCw size={14} />
        </button>
        {unread > 0 && (
            ...
            {notifs.map((n) => (
              <div key={n.id}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {n.href && (
                    <Link href={n.href} className="text-[10px] text-blue-500 font-semibold hover:underline mt-1 inline-block">View →</Link>
                  )}
                </div>

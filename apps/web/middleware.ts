...
const ROUTE_FEATURE: Array<[string, string]> = [
  ...
  ['/receptionist/live-flow',                           'liveFlow'],
  ...
  ['/receptionist/ai-suite/knowledge-base',             'knowledgeBase'],
  ['/doctor/followup-dashboard',                        'aiSuiteFollowup'],
  ['/doctor/confirmation-dashboard',                    'aiSuiteConfirmation'],
  ['/accounts',                                         'accounts'],
  ['/audit-log',                                        'auditLog'],
]
